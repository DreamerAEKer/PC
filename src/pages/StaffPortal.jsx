          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <ol style={{ paddingLeft: '1.25rem', fontSize: '10.5pt', margin: '0', lineHeight: '1.5' }}>
              <li style={{ marginBottom: '0.4rem' }}>
                <strong>เขียนชื่อประเทศ:</strong> ในช่องว่างทายผล <strong>"แชมป์คือ..."</strong> บนไปรษณียบัตร ให้เขียน<strong>ชื่อประเทศที่คุณทายว่าจะได้เป็นแชมป์เพียง 1 ประเทศเท่านั้น</strong> (เขียนให้ตัวอักษรชัดเจนอ่านง่าย เช่น <em>อังกฤษ, ฝรั่งเศส, อาร์เจนตินา, สเปน, บราซิล</em> ฯลฯ)
              </li>
              <li style={{ marginBottom: '0.4rem' }}>
