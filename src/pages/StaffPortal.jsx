    ...
    <>
      ...
      {isPrintingGuide && (
        <div className="guide-print-only" style={{
          ...
          {/* Header */}
          <div style={{ textAlign: 'center', marginBottom: '2.5rem', borderBottom: '3px double #000', paddingBottom: '1.5rem' }}>
            <h1 style={{ margin: '0 0 0.5rem 0', fontSize: '24pt', fontWeight: 'bold', color: '#b91c1c' }}>🏆 คู่มือแนะนำการร่วมลุ้นโชคไปรษณียบัตร 🏆</h1>
            <h2 style={{ margin: '0', fontSize: '16pt', fontWeight: 'bold', color: '#1e3a8a' }}>แคมเปญ "เชียร์บอลให้มัน เฮลั่นรับโชค"</h2>
            <p style={{ margin: '0.5rem 0 0 0', fontSize: '12pt', color: '#475569' }}>
              ข้อมูลสนับสนุนเพื่ออำนวยความสะดวกสำหรับลูกค้าของ {branchName}
            </p>
          </div>

          {/* Section 1: วิธีการส่ง */}
          <div style={{ marginBottom: '2rem' }}>
            <h3 style={{ fontSize: '14pt', fontWeight: 'bold', borderBottom: '1px solid #ccc', paddingBottom: '0.3rem', color: '#1e3a8a' }}>
              📝 วิธีร่วมลุ้นรางวัล (ไปรษณียบัตรแบบกระดาษ)
            </h3>
            <ol style={{ paddingLeft: '1.5rem', fontSize: '11.5pt', margin: '0.75rem 0' }}>
              <li style={{ marginBottom: '0.75rem' }}>
                <strong>ตรวจสอบชื่อ-ที่อยู่ของตัวท่าน:</strong> ทางร้านค้าได้ทำการ<strong>พิมพ์ชื่อ เบอร์โทรศัพท์ และที่อยู่ของท่านไว้บนไปรษณียบัตรเรียบร้อยแล้ว</strong> (ไม่ต้องเขียนด้วยมือเพื่อป้องกันความผิดพลาดและประหยัดเวลา)
              </li>
              <li style={{ marginBottom: '0.75rem' }}>
                <strong>ทายชื่อทีมแชมป์:</strong> ในช่องว่างทายผล (หรือตรงบริเวณจุดที่กำหนด) ให้ท่านใช้<strong>ปากกาเขียนชื่อประเทศที่คุณเชียร์เพียงชื่อเดียวเท่านั้น</strong> ให้ตัวอักษรชัดเจนอ่านง่าย (เช่น <em>อังกฤษ, ฝรั่งเศส, อาร์เจนตินา, สเปน, บราซิล</em> เป็นต้น)
              </li>
              <li style={{ marginBottom: '0.75rem' }}>
                <strong>ส่งชิงโชค:</strong> นำไปรษณียบัตรไปหยอดที่ตู้ไปรษณีย์ หรือฝากส่ง ณ ที่ทำการไปรษณีย์ทุกสาขาได้ทั่วประเทศ (ไม่จำเป็นต้องติดแสตมป์เพิ่ม)
              </li>
            </ol>
          </div>

          {/* Section 2: วันหมดเขต */}
          <div style={{ marginBottom: '2rem', border: '1.5px solid #b91c1c', padding: '1rem', borderRadius: '8px', backgroundColor: '#fff5f5' }}>
            <h3 style={{ fontSize: '13pt', fontWeight: 'bold', margin: '0 0 0.5rem 0', color: '#b91c1c', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ⚠️ วันหมดเขตรับไปรษณียบัตร
            </h3>
            <p style={{ margin: '0', fontSize: '12pt', fontWeight: 'bold', color: '#7f1d1d' }}>
              หมดเขตรับชิงโชคภายในวันที่ 19 กรกฎาคม 2569
            </p>
            <p style={{ margin: '0.25rem 0 0 0', fontSize: '11pt', color: '#451a03' }}>
              * สำหรับไปรษณียบัตรกระดาษ ต้องส่งถึงไปรษณีย์หรือตู้ไปรษณีย์ปิดรับเวลา <strong>18:00 น.</strong> ของวันที่ 19 ก.ค. 2569 เท่านั้น (ยึดตามตราประทับประจำวันของไปรษณีย์)
            </p>
          </div>
          ...
          <div style={{ marginBottom: '2.5rem' }}>
            <h3 style={{ fontSize: '14pt', fontWeight: 'bold', borderBottom: '1px solid #ccc', paddingBottom: '0.3rem', color: '#1e3a8a' }}>
              🎁 รายละเอียดของรางวัล (รวมมูลค่ากว่า 12 ล้านบาท)
            </h3>
            <p style={{ margin: '0.5rem 0', fontSize: '11.5pt' }}>
              รางวัลจับคูปองแบ่งตามการทายผลบอลโลก 2026 มีรายการรวมกว่า 300 รางวัลดังนี้:
            </p>
            <ul style={{ paddingLeft: '1.5rem', fontSize: '11pt', margin: '0.5rem 0' }}>
              <li style={{ marginBottom: '0.4rem' }}><strong>รางวัลที่ 1:</strong> ทองคำแท่งหรือเงินสดมูลค่ารางวัลใหญ่สุด (ตามเงื่อนไขแคมเปญ)</li>
              <li style={{ marginBottom: '0.4rem' }}><strong>รางวัลอื่นๆ:</strong> รถยนต์, รถจักรยานยนต์, สมาร์ตโฟน และบัตรกำนัลช้อปปิ้งมูลค่าสูง</li>
              <li style={{ marginBottom: '0.4rem' }}><strong>พิเศษยิ่งขึ้น:</strong> รอบนี้มีการแบ่งการจับรางวัลออกเป็น 2 รอบใหญ่ (รอบ 16 ทีมสุดท้าย และรอบชิงชนะเลิศ) ทำให้ส่งลุ้นรางวัลได้สนุกและมีสิทธิ์ลุ้นบ่อยขึ้น</li>
            </ul>
          </div>
          ...
          <div style={{ marginBottom: '3rem' }}>
            ...
            <p style={{ margin: '0.5rem 0', fontSize: '11.5pt' }}>
              ท่านสามารถรับชมและตรวจสอบรายชื่อผู้โชคดีอย่างเป็นทางการได้ทางช่องทางต่อไปนี้:
            </p>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem', marginTop: '0.75rem', textAlign: 'center' }}>
              <div style={{ border: '1px solid #e2e8f0', padding: '0.75rem', borderRadius: '6px', backgroundColor: '#f8fafc' }}>
                <div style={{ fontSize: '18pt' }}>📰</div>
                <strong style={{ fontSize: '10.5pt', display: 'block', marginTop: '0.25rem' }}>หนังสือพิมพ์ไทยรัฐ</strong>
              </div>
              <div style={{ border: '1px solid #e2e8f0', padding: '0.75rem', borderRadius: '6px', backgroundColor: '#f8fafc' }}>
                <div style={{ fontSize: '18pt' }}>🌐</div>
                <strong style={{ fontSize: '10.5pt', display: 'block', marginTop: '0.25rem' }}>ไทยรัฐออนไลน์ (thairath.co.th)</strong>
              </div>
              <div style={{ border: '1px solid #e2e8f0', padding: '0.75rem', borderRadius: '6px', backgroundColor: '#f8fafc' }}>
                <div style={{ fontSize: '18pt' }}>📺</div>
                <strong style={{ fontSize: '10.5pt', display: 'block', marginTop: '0.25rem' }}>ไทยรัฐทีวี ช่อง 32</strong>
              </div>
            </div>
          </div>

          {/* Footer note */}
          <div style={{ textAlign: 'center', fontSize: '10pt', color: '#64748b', borderTop: '1px dashed #cbd5e1', paddingTop: '1rem' }}>
            ขอขอบพระคุณที่ใช้บริการสั่งพิมพ์ไปรษณียบัตรกับ {branchName}<br/>
            ขอให้ทุกท่านโชคดีและสนุกกับการเชียร์ศึกฟุตบอลระดับโลก!
          </div>
        </div>
      )}
